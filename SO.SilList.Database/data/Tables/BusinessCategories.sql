CREATE TABLE [data].[BusinessCategories] (
    [businessCategoryId]     UNIQUEIDENTIFIER CONSTRAINT [DF_BusinessCategories_businessCategoryId] DEFAULT (newid()) NOT NULL,
    ...
    CONSTRAINT [PK_BusinessCategories_1] PRIMARY KEY CLUSTERED ([businessCategoryId] ASC),
