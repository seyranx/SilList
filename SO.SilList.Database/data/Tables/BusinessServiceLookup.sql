CREATE TABLE [data].[BusinessServiceLookup] (
    ...
    [businessServiceTypeId]   INT              NULL,
    ...
    CONSTRAINT [FK_BusinessServices_ServiceType] FOREIGN KEY ([businessServiceTypeId]) REFERENCES [app].[BusinessServiceType] ([businessServiceTypeId]) ON DELETE CASCADE ON UPDATE CASCADE
);
