CREATE TABLE [data].[Listing] (
    ...
    CONSTRAINT [FK_Listing_CityType] FOREIGN KEY ([cityId]) REFERENCES [app].[CityType] ([cityTypeId]) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT [FK_Listing_CountryType] FOREIGN KEY ([countryId]) REFERENCES [app].[CountryType] ([countryTypeId]) ON DELETE CASCADE ON UPDATE CASCADE,
    ...
    CONSTRAINT [FK_Listing_StateType] FOREIGN KEY ([stateId]) REFERENCES [app].[StateType] ([stateTypeId]) ON DELETE CASCADE ON UPDATE CASCADE
);
