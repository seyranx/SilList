CREATE TABLE [data].[Listing] (
    ...
    [listingStatusTypeId] INT              CONSTRAINT [DF__Listing__isAppro__7F80E8EA] DEFAULT ((1)) NULL,
    [createdBy ]          INT              NULL,
    [modifiedBy]          INT              NULL,
    ...
    CONSTRAINT [FK_Listing_EntryStatusType] FOREIGN KEY ([listingStatusTypeId]) REFERENCES [app].[ListingStatusType] ([listingStatusTypeId]) ON DELETE CASCADE ON UPDATE CASCADE,
