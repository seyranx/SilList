CREATE TABLE [data].[Listing] (
    ...
    CONSTRAINT [FK_Listing_EntryStatusType] FOREIGN KEY ([entryStatusTypeId]) REFERENCES [app].[ListingStatusType] ([listingStatusTypeId]) ON DELETE CASCADE ON UPDATE CASCADE,
