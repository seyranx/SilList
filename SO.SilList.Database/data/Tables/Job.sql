CREATE TABLE [data].[Job] (
    ...
    [listingStatusTypeId] INT              CONSTRAINT [DF__tmp_ms_xx__isApp__3B0BC30C] DEFAULT ((1)) NULL,
    ...
    CONSTRAINT [FK_Job_EntryStatusType] FOREIGN KEY ([listingStatusTypeId]) REFERENCES [app].[ListingStatusType] ([listingStatusTypeId]) ON DELETE CASCADE ON UPDATE CASCADE,
