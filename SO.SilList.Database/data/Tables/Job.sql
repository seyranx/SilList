CREATE TABLE [data].[Job] (
    ...
    [isTravelRequired]  BIT              CONSTRAINT [DF__Job__isTravelReq__69FBBC1F] DEFAULT ((0)) NOT NULL,
    [isTelecomute]      BIT              CONSTRAINT [DF__Job__isTelecomut__6AEFE058] DEFAULT ((0)) NOT NULL,
