CREATE TABLE [data].[Property] (
    ...
    [size]                  INT              NULL,
    [lotSize]               INT              NULL,
    [acceptsSection8TypeId]       INT              NULL,
    ...
    [entryStatusTypeId]     INT              CONSTRAINT [DF__tmp_ms_xx__entry__386F4D83] DEFAULT ((1)) NULL,
    [isPetAllowedTypeId]          INT              NULL,
    ...
    CONSTRAINT [FK_Property_AcceptsSection8Type] FOREIGN KEY ([acceptsSection8TypeId]) REFERENCES [app].[AcceptsSection8Type] ([acceptsSection8TypeId]) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT [FK_Property_IsPetAllowedType] FOREIGN KEY ([isPetAllowedTypeId]) REFERENCES [app].[IsPetAllowedType] ([isPetAllowedTypeId]) ON DELETE CASCADE ON UPDATE CASCADE,
